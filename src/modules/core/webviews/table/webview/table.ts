...
export async function renderTableResult() {
    ...
    let startRenderTable = performance.now();
...
function renderTableHeader() {
    ...
    const queryResult = getQueryResult();
    // table header
    let tableRowHead = document.createElement("div");
...
export function createTableRow(i: number, row: QueryResultRow, isNewRow: boolean = false) {
