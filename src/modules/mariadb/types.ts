/* eslint-disable */
// eslint disable because of mysql type maps
...
export type MySQLField = {
    ...
    "name": "id",
    "columnLength": number,
    "columnType": keyof typeof mysqlTypeMap,
    "flags": number,
    "decimals": string,
};

// https://github.com/sidorares/node-mysql2/blob/fefe036512624b384d48c926b11e7a986f7ae57c/lib/constants/types.js
